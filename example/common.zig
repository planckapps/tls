...
pub const Counter = struct {
    ...
    pub fn add(self: *@This(), io: Io, res: Result) void {
    ...
    pub fn addSuccess(self: *@This(), io: Io, version: tls.config.Version) void {
        self.mu.lockUncancelable(io);
        defer self.mu.unlock(io);
    ...
    pub fn total(self: *@This(), io: Io) usize {
        self.mu.lockUncancelable(io);
        defer self.mu.unlock(io);
        return self.success + self.fail + self.skip + self.err;
    }

    pub fn show(self: *@This(), io: Io) void {
        std.debug.print(
            "stats:\n\t total: {}\n\t success: {}\n\t\t tls 1.2: {}\n\t\t tls 1.3: {}\n\t fail: {}\n\t error: {}\n\t skip: {}\n\n",
